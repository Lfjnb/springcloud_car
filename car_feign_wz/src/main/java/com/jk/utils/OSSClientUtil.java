...
public class OSSClientUtil {
	 ...
	 */
	private String accessKeyId = "LTAIKRDC9O7Ltdgf";  //需要改
	private String accessKeySecret ="InfZFnw3pxOvQ58xgT5zcqMRNb3DQ0"; //需要改

	/**
	 * 填写创建的Bucket名称
	 */
	// 空间
	private String bucketName = "suncj";//需要改
	// 文件存储目录   对应Bucket的文件夹名称
	private String filedir = "imgs/";//需要改
